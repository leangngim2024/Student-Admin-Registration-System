...
public class Admin_login extends JFrame {
    ...
    private void initUI() {
        JLabel title = new JLabel("Login to Admin Page");
        ...
        JButton exit_btn = new JButton("Exit the system");
        exit_btn.setBounds(80, 190, 300, 30); // x, y, width, height
        exit_btn.setBackground(new Color(220, 220, 220));
        exit_btn.setBorder(BorderFactory.createLineBorder(Color.BLUE, 0));
        inputPanel.add(exit_btn);
    ...
    public void MyLogin(){
        ...
        try {
            ...
            if(check == true){
               StudentRegister student_register = new StudentRegister();
               student_register.setVisible(true);
            }else {
...
class BackgroundPanel1 extends JPanel {
        ...
        public BackgroundPanel1() {
            backgroundImage = new ImageIcon(getClass().getResource("/skyArea.jpg")).getImage(); // Make sure the image is in /resources
        }
